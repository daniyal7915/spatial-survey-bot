...
PHOTO_NS = 'The photo was not saved, please send it at an appropriate stage'
VIDEO_NS = 'The video was not saved, please send it at an appropriate stage'
...
FOLLOW_TEMPLATE = 'Invalid input! Follow the template: 45, 45 (where the first digit is Latitude,' \
                  'the second one is Longitude. Decimal places can be any.'
